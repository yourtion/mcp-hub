...
function main() {
  ...
  // 显示总体覆盖率
  console.log('\n📈 项目总体覆盖率:')
  console.log(`  行覆盖率: ${summary.total.lines.pct.toFixed(2)}% (${summary.total.lines.covered}/${summary.total.lines.total})`)
  console.log(`  函数覆盖率: ${summary.total.functions.pct.toFixed(2)}% (${summary.total.functions.covered}/${summary.total.functions.total})`)
  console.log(`  语句覆盖率: ${summary.total.statements.pct.toFixed(2)}% (${summary.total.statements.covered}/${summary.total.statements.total})`)
  console.log(`  分支覆盖率: ${summary.total.branches.pct.toFixed(2)}% (${summary.total.branches.covered}/${summary.total.branches.total})`)
